...
namespace Happimeter.ViewModels.Forms
{
    public class SignInViewModel : BaseViewModel
    {
        public SignInViewModel()
        {
            ...
            {
                if (!AgreeToScienceUse || !AgreeToTerms)
                {
                    await Application.Current.MainPage.DisplayAlert("Error", "You have to check both checkboxes to use our app", "ok");
                    return;
                }
        ...
        private bool _agreeToScienceUse;
        public bool AgreeToScienceUse
        {
            get => _agreeToScienceUse;
            set => SetProperty(ref _agreeToScienceUse, value);
        }

        public ICommand PrivacyPolicyClickedCommand = new Command(() =>
            {
                Device.OpenUri(new System.Uri("https://happimeter.org"));
            });
    }
}
