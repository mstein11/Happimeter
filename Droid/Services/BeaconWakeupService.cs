...
namespace Happimeter.Droid.Services
{
    public class BeaconWakeupService : Java.Lang.Object, IBeaconWakeupService, IBeaconConsumer
    {
        ...
        {
            BeaconManager.ForegroundScanPeriod = 60 * 1000;
            BeaconManager.BackgroundScanPeriod = 60 * 1000;
            BeaconManager.BackgroundBetweenScanPeriod = 300 * 1000;
            BeaconManager.ForegroundBetweenScanPeriod = 60 * 1000;
